...
$L1Section18 = @{
    ...
    'HKLM\SOFTWARE\Policies\Microsoft\Internet Explorer\Main' = @(
        @{ 'key' = 'NotifyDisableIEOptions'; 'type' = 'exact'; 'value' = 1 }
    )
...
$SectionBitlocker = @{
    'HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System' = @(
        @{ 'key' = 'MaxDevicePasswordFailedAttempts'; 'comparison' = 'exact'; 'value' = "x -lt 10 -and x -gt 0" }
    )
    ...
    'HKLM\SOFTWARE\Policies\Microsoft\Windows\DeviceInstall\Restrictions\DenyDeviceClasses' = @(
        @{ 'key' = '2'; 'type' = 'exact'; 'value' = "{7ebefbc0-3200-11d2-b4c2-00a0C9697d07}" },
        @{ 'key' = '4'; 'type' = 'exact'; 'value' = "{6bdd1fc1-810f-11d0-bec7-08002be2092f}" },
        @{ 'key' = '1'; 'type' = 'exact'; 'value' = "{d48179be-ec20-11d1-b6b8-00c04fa372a7}" },
        @{ 'key' = '3'; 'type' = 'exact'; 'value' = "{c06ff265-ae09-48f0-812c-16753d7cba83}" }
    )
...
#function to compare UserRights to expected
